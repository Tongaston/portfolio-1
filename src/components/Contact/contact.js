    ...
    <section id="contactSection">
      ...
      <footer className="contactFooter">
        <ul className="listaFooter">
          <li>
            <a
              href="https://www.linkedin.com/in/gaston-moure/"
              target="_blank"
              rel="noopener noreferrer"
            >
              <svg className="logoFooter" viewBox="0 0 256 256">
                <path
          ...
          <li>
            <a
              href="https://github.com/Tongaston"
              target="_blank"
              rel="noopener noreferrer"
            >
              <svg className="logoFooter" viewBox="0 0 256 250">
                <path
          ...
          <li>
            <a
              href="https://twitter.com/GastonMoure"
              target="_blank"
              rel="noopener noreferrer"
            >
              <svg
